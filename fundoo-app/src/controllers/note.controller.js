...
export const archiveNote = async(req, res) => {
    try {
        const data = await NoteService.archiveNote(req.params._id, req.body, req.body.userId);
        res.status(HttpStatus.ACCEPTED).json({
            code: HttpStatus.ACCEPTED,
            data: data,
...
export const trashNote = async(req, res) => {
    try {
        const data = await NoteService.trashNote(req.params._id, req.body, req.body.userId);
        res.status(HttpStatus.ACCEPTED).json({
            code: HttpStatus.ACCEPTED,
            data: data,
